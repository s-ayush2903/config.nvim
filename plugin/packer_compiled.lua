...
_G.packer_plugins = {
  ...
  ["auto-pairs"] = {
    loaded = true,
    path = "/home/ayush/.local/share/nvim/site/pack/packer/start/auto-pairs",
  ...
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/home/ayush/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  ["nvim-cmp"] = {
    loaded = true,
    path = "/home/ayush/.local/share/nvim/site/pack/packer/start/nvim-cmp",
  ...
  ["rose-pine"] = {
    ...
    loaded = true,
    path = "/home/ayush/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  undotree = {
    loaded = true,
    path = "/home/ayush/.local/share/nvim/site/pack/packer/start/undotree",
